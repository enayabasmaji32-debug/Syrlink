...
GOOGLE_CLIENT_ID = os.getenv("GOOGLECLIENTID") or os.getenv("GOOGLE_CLIENT_ID")
GOOGLE_CLIENT_SECRET = os.getenv("GOOGLECLIENTSECRET") or os.getenv("GOOGLE_CLIENT_SECRET")
