...
export const postsApi = {
  ...
  likeComment: (postId, commentId) => c.post(`/posts/${postId}/comments/${commentId}/like`).then((r) => r.data),
};
...
export const adminApi = {
  ...
  reject: (id, reason = '') => c.post(`/admin/verification-requests/${id}/reject?reason=${encodeURIComponent(reason)}`).then((r) => r.data),
  updateStage: (id, stage) => c.post(`/admin/verification-requests/${id}/stage?new_stage=${stage}`).then((r) => r.data),
