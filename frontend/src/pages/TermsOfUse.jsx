  ...
  return (
    <div className="min-h-screen bg-[#f4f2ee]">
      ...
      <div className="prose prose-invert max-w-none leading-relaxed text-right max-w-4xl mx-auto p-6" dir="rtl">
        ...
        <p>منصة SyrLink توفر بيئة احترافية وآمنة للمهنيين والشركات والمستثمرين.</p>
        <p>
          تلتزم المنصة بحماية بيانات وخصوصية المستخدمين وتطبيق أعلى معايير الأمان والحماية.
        </p>
        <p>يحتفظ المستخدم بكامل المسؤولية عن المحتوى الذي ينشره على المنصة.</p>
        <p className="mt-6">
