...
export default function Register() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      toast.success('Welcome to SyrLink!');
      navigate('/');
    } catch (e) {
    ...
    <div className="min-h-screen flex flex-col items-center pt-10 px-4 bg-[#f4f2ee]">
      ...
      <div className="li-card w-full max-w-md p-7 shadow-sm">
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            <label className="text-xs font-semibold text-gray-700">Password (6+ characters)</label>
            <input
          ...
          <div>
            <label className="text-xs font-semibold text-gray-700">Headline (optional)</label>
            <input
